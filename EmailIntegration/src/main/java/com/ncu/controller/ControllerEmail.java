...
import com.ncu.model.ModelEmail;

@Controller
public class ControllerEmail {

	static String emailToRecipient,emailSubject, emailMessage,emailFileName;
	static final String emailFromRecipient = "zhkhan2001@gmail.com";
...
//	static ModelAndView modelViewObj;
	...
	public String showEmailForm(Model m,@ModelAttribute("email") ModelEmail email ) {
		String name = "Zaid";
	...
	public String send(Model m , @Valid @ModelAttribute("email") ModelEmail email,BindingResult br) {
		if(br.hasErrors()) {
			String name = "Zaid";
			m.addAttribute("name", name);
			return "emailForm";
